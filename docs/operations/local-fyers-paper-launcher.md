...
3. Complete FYERS login and 2FA when prompted.
4. The launcher opens the local dashboard at `http://localhost:8501`. Open **Configuration → Fyers**, paste the daily access token, and save it.
